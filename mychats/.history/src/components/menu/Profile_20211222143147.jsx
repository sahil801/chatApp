...
function Profile() {
    ...
    return (
        <div className={classnames.profile}>
            ...
            <div className={classnames.discripition} >
                <personalbar>This is not your username or pin. This name will be visible to your WhatsApp contacts.</personalbar>
            </div>
            <div></div>
        </div>
    )
