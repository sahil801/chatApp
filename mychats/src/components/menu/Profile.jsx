        ...
        <div className={classnames.profile}>
            ...
            <div  className={classnames.whitebg}>
                <div>
                    <p>About</p>
                    <div style={{display:'flex',justifyContent:'space-between',padding:0,margin:'9px 0'}}>
                      <span style={{fontSize:18,color:'#4a4a4a'}}>web devloper 😎</span>  <FaPen/>
                    </div>
                </div>
            </div>
        </div>
